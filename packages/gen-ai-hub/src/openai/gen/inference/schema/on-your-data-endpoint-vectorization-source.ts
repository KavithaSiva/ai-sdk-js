 ...
 */
import type { OpenAiOnYourDataVectorizationSource } from './on-your-data-vectorization-source.js';
 ...
 */
export type OpenAiOnYourDataEndpointVectorizationSource =
  OpenAiOnYourDataVectorizationSource & {
    authentication: OpenAiOnYourDataApiKeyAuthenticationOptions;
    /**
