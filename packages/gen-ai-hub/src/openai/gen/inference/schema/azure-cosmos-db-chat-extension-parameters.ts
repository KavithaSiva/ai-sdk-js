 ...
 */
import type { OpenAiOnYourDataConnectionStringAuthenticationOptions } from './on-your-data-connection-string-authentication-options.js';
import type { OpenAiAzureCosmosDBFieldMappingOptions } from './azure-cosmos-db-field-mapping-options.js';
 ...
 * MongoDB vCore.
 */
export type OpenAiAzureCosmosDBChatExtensionParameters = {
  authentication: OpenAiOnYourDataConnectionStringAuthenticationOptions;
  /**
   ...
   */
  index_name: string;
  fields_mapping: OpenAiAzureCosmosDBFieldMappingOptions;
